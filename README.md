...
- **Core modules** such as Forms run with the CMS: in Typeroll Cloud for hosted customers and in the operator's environment for self-hosted installations.
...
- **Third-party Connectors** integrate provider-owned SaaS or bespoke systems. Their backends and data remain in the developer's own accounts, and published components call those APIs directly. Typeroll and customer hosting accounts do not act as reverse proxies.
...
See the public [Connector architecture](https://docs.typeroll.com/extensions/overview/) and [self-hosting guide](https://docs.typeroll.com/guides/self-hosting/) for the protocol and deployment model.
