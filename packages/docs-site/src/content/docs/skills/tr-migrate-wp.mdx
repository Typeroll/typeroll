...
- 1–2 example pages if possible — the AI agent uses them as design references
...
Each CPT becomes a Typeroll content type whose records are Pages. The schema is inferred from a sample item's ACF fields and post meta:
