...
export const pageTools: ToolDef[] = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      breadcrumb_label: z.string().max(200).nullable().optional().describe('Optional short breadcrumb label. Leaves Page title, SEO title and route unchanged; null/empty uses the title.'),
