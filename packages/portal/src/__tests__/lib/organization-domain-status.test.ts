...
import { getOrganizationDomains } from '../../lib/publishing/domain-config';
...
vi.mock('../../lib/publishing/domain-config', async original => ({ ...await original<any>(), getOrganizationDomains: vi.fn() }));
