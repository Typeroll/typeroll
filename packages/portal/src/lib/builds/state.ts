...
export interface EngineConfiguration { media_preparation?: boolean;
...
export interface BuildInput { provider?: BuildProvider; dispatch_nonce?: string; source_key: string; kind: 'qualification' | 'publication' | 'media_preparation'; dispatch_id?: string; dispatch_uncertain?: boolean; dispatch_started_at?: number; dispatch_attempt?: number; dispatch_lease_until?: number; storage_account_id: string }
