...
export class ProviderError extends Error { constructor(provider: string, status: number, codes?: number[]); status: number; codes: number[]; }
...
export function assertSuccessfulStaticDeployment(deployment: any): void;
