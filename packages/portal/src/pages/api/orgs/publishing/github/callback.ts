...
import { finishGithubConnection, GITHUB_COOKIE } from '../../../../../lib/publishing/github-connection';
...
export const GET: APIRoute = async (context) => {
  ...
  let result = 'failed';
  try {
    await finishGithubConnection(guard.value, { state: context.url.searchParams.get('state') ?? '',
